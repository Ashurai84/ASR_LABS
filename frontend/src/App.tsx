  ...
  return (
    <div className="flex min-h-screen bg-black text-zinc-300 font-sans selection:bg-orange-900/30 selection:text-orange-200 lg:overflow-visible overflow-hidden">
      ...
      <main className="flex-1 md:ml-64 relative min-h-screen">
        <div
          key={viewKey}
          className={`mx-auto px-6 md:px-12 pt-24 md:pt-12 w-full transition-opacity duration-300 animate-[fadeIn_0.3s_ease-out] ${view === 'tools' ? 'max-w-6xl' : (view === 'journal' && selectedProjectId) ? 'max-w-4xl' : 'max-w-3xl'
            }`}
        >
          {view === 'journal' && !selectedProjectId && (
            <JournalStream

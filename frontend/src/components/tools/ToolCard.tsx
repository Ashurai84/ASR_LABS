...
export const ToolCard: React.FC<ToolCardProps> = ({ tool }) => {
    ...
    return (
        <div className="group block no-underline h-[280px] w-full bg-[#111] border border-zinc-800/80 rounded-2xl p-6 transition-all duration-300 hover:border-zinc-700 hover:bg-[#141414] relative overflow-hidden flex flex-col cursor-pointer">
            
            <div className="flex-grow z-10 flex flex-col justify-start">
            ...
            <div className="flex flex-wrap items-center justify-between gap-4 pt-5 border-t border-zinc-800/50 shrink-0 group-hover:border-zinc-700/50 transition-colors mt-auto z-10 relative">
